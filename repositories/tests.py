...
class TestRepositoryApi(APITestCase):
    ...
    def test_create_repository(self):
        """
        Ensure we can create a new repository object.
        """
    ...
    def test_list_repositories(self):
        """
        Ensure we can list all repositories.
        """
        url = reverse('repositories:repository-list')
    ...
    def test_get_repository(self):
        """
        Ensure we can get a specific repository object.
        """
    ...
    def test_put_repository(self):
        """
        Ensure we can update a specific repository object.
        """
        url = reverse('repositories:repository-detail', kwargs={'pk': 1})
        data = {'name': 'Project2'}
    ...
    def test_delete_repository(self):
        """
        Ensure we can delete a specific repository object.
        """
        url = reverse('repositories:repository-detail', kwargs={'pk': 1})
